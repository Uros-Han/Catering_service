...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color Difference BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Difference(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
