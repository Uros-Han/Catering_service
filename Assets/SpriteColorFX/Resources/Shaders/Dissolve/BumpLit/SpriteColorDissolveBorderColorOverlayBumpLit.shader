...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color Overlay BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Overlay(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
