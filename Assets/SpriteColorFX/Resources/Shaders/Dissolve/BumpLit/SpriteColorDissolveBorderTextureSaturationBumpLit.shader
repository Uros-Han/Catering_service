...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Texture Saturation BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Saturation(pixel.rgb, pixelBorder.rgb), 0.0, isClear);
