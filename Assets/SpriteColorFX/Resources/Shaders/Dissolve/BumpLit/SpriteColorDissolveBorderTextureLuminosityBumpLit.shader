...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Texture Luminosity BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Luminosity(pixel.rgb, pixelBorder.rgb), 0.0, isClear);
