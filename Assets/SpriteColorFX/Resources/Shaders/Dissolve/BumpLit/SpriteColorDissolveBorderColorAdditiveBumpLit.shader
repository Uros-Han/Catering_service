...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color Additive BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Additive(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
