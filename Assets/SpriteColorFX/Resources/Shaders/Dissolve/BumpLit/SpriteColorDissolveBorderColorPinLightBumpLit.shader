...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color PinLight BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(PinLight(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
