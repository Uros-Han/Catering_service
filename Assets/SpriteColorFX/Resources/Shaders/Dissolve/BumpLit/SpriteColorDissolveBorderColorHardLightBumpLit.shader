...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color HardLight BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(HardLight(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
