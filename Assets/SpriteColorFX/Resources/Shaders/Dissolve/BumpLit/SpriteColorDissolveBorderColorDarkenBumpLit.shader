...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color Darken BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Darken(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
