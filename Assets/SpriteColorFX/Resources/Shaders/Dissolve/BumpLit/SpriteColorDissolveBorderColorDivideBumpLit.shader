...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color Divide BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(Divide(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
