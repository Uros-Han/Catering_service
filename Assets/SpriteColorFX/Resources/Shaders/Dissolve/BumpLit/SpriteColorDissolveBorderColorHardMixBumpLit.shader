...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color HardMix BumpLit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed3 altCol = lerp(HardMix(pixel.rgb, _DissolveLineColor.rgb), 0.0, isClear);
