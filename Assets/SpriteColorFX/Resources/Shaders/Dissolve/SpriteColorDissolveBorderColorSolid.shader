...
Shader "Sprites/Sprite Color FX/Sprite Color Dissolve Border Color Solid"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      fixed4 altCol = lerp(_DissolveLineColor, 0.0, isClear);
      
	  o.Albedo = lerp(pixel, altCol, isAtLeastLine);
