...
Shader "Sprites/Sprite Color FX/Sprite Color Outline Gradient Vertical"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
	{
      ...
      fixed4 mainColor = spriteColor.a > (1.0 - _AlphaThreshold) ? spriteColor : lerp(outlinePixel.a * _OutlineColor2, outlinePixel.a * _OutlineColor, IN.localPos.y * _GradientScale + _GradientOffset);
