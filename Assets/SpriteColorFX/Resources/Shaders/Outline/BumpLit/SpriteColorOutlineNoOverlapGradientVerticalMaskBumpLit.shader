...
Shader "Sprites/Sprite Color FX/Sprite Color Outline Gradient Vertical Mask Bump Lit NoOverlap"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
	{
      ...
      fixed4 mainColor = lerp(outlinePixel.a * _OutlineColor2, outlinePixel.a * _OutlineColor, IN.localPos.y * _GradientScale + _GradientOffset);
