...
Shader "Sprites/Sprite Color FX/Sprite Color Outline NoOverlap Gradient Horizontal Mask Bump Lit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
	{
      ...
      fixed4 mainColor = lerp(outlinePixel.a * _OutlineColor, outlinePixel.a * _OutlineColor2, IN.localPos.x * _GradientScale + _GradientOffset);
