...
Shader "Sprites/Sprite Color FX/Sprite Color Outline Gradient Horizontal"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
	{
      ...
      fixed4 mainColor = spriteColor.a > (1.0 - _AlphaThreshold) ? spriteColor : lerp(outlinePixel.a * _OutlineColor, outlinePixel.a * _OutlineColor2, IN.localPos.x * _GradientScale + _GradientOffset);
