...
Shader "Sprites/Sprite Color FX/Sprite Color Outline Gradient Vertical Mask"
{
	...
	SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			if (maskPixel.a < (1.0 - _AlphaThreshold))
				mainColor = lerp(outlinePixel.a * _OutlineColor2, outlinePixel.a * _OutlineColor, IN.localPos.y * _GradientScale + _GradientOffset);
