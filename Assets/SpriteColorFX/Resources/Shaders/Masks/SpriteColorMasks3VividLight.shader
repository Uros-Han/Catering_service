...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 VividLight"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, VividLight(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
