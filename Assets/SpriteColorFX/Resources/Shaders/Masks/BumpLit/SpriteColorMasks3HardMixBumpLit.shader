...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 HardMix Bump Lit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, HardMix(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
