...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 Lighter Bump Lit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, Lighter(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
