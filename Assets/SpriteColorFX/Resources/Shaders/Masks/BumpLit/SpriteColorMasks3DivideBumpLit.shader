...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 Divide Bump Lit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, Divide(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
