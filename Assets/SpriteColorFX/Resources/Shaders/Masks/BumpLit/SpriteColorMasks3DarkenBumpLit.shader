...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 Darken Bump"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, Darken(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
