...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 Additive Bump Lit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, Additive(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
