...
Shader "Sprites/Sprite Color FX/Sprite Color Masks 3 Burn Bump Lit"
{
  ...
  SubShader
  {
    ...
    void surf(Input IN, inout SurfaceOutput o)
    {
      ...
      float3 final = lerp(pixel.rgb, Burn(pixel.rgb, colorMask), colorMaskR + colorMaskG + colorMaskB);
