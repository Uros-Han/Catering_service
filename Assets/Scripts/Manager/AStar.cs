...
public class AStar : Singleton<AStar>
{
    ...
    void MakeBestList_World(bool bCreateNewList)
    {
        ...
        while (true)
        {
            ...
            // 위
            if (ParentNode.iIndex >= m_iTileCountX // up check
                && !geoTransform.GetChild(ParentNode.iIndex - m_iTileCountX).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.CLIFF)
            ...
            // 오위
            if (ParentNode.iIndex >= m_iTileCountX // up check
                && (ParentNode.iIndex + 1) % m_iTileCountX != 0 // right check
                && !geoTransform.GetChild(ParentNode.iIndex - m_iTileCountX + 1).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.CLIFF)
            ...
            // 오
            if ((ParentNode.iIndex + 1) % m_iTileCountX != 0 // right check
                && !geoTransform.GetChild(ParentNode.iIndex + 1).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.CLIFF)
            ...
            // 오아
            if (ParentNode.iIndex < m_iTileCountX * m_iTileCountY - m_iTileCountX // down check
                && (ParentNode.iIndex + 1) % m_iTileCountX != 0 // right check
                && !geoTransform.GetChild(ParentNode.iIndex + 1 + m_iTileCountX).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.CLIFF)
            ...
            // 왼아
            if (ParentNode.iIndex % m_iTileCountX != 0 // left check
                && ParentNode.iIndex < m_iTileCountX * m_iTileCountY - m_iTileCountX // down check
                && !geoTransform.GetChild(ParentNode.iIndex + m_iTileCountX - 1).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.CLIFF)
                && !geoTransform.GetChild(ParentNode.iIndex + m_iTileCountX - 1).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.WATER)
                && CheckList(ParentNode.iIndex + m_iTileCountX - 1))
            {
            ...
            // 왼위
            if (ParentNode.iIndex >= m_iTileCountX //up check
                && ParentNode.iIndex % m_iTileCountX != 0 // left check
                && !geoTransform.GetChild(ParentNode.iIndex - 1 - m_iTileCountX).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.CLIFF)
                && !geoTransform.GetChild(ParentNode.iIndex - 1 - m_iTileCountX).GetComponent<WorldGeo>().m_geoStatus.Equals(WORLD_GEO.WATER)
                && CheckList(ParentNode.iIndex - 1 - m_iTileCountX))
            {
