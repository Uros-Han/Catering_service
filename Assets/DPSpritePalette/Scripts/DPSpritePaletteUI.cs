...
public class DPSpritePaletteUI : MonoBehaviour, UnityEngine.UI.IMaterialModifier
{
    /// <summary>
	...
	private UnityEngine.UI.Image sp;
    ...
    void Awake()
	{
		...
		sp = GetComponent<UnityEngine.UI.Image>();
    ...
    public void Refresh()
    {
        sp.material = Instantiate(paletteMaterial);
        GetModifiedMaterial(sp.material);
    }
	...
	{
		baseMaterial.SetTexture("_PaletteTex", paletteTexture);
		baseMaterial.SetVector("_PaletteTextureSize", CalcPixelSize());
        baseMaterial.SetVector("_SpriteSize", CalcSpriteSize());
        return baseMaterial;
	}
