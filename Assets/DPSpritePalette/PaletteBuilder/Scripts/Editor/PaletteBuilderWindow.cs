...
public class PaletteBuilderWindow : EditorWindow {
	...
	[MenuItem ("Window/DP Sprite Palette/Palette Builder - Photoshop Act")]
	static void CreatePBWindow () 
	{
		PaletteBuilderWindow window = (PaletteBuilderWindow) EditorWindow.GetWindow(typeof(PaletteBuilderWindow), true, "Palette Builder - Photoshop Act");
		window.Show();
	}
